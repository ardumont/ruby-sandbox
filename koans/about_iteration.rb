...
class AboutIteration < EdgeCase::Koan
  ...
  def test_inject_will_blow_your_mind
    ...
    ## clojure's reduce
    # the parameter of inject is the start accumulator named sum in the unit tests
    # then it's used to sum or multiply with the next item, the result then serves as the
